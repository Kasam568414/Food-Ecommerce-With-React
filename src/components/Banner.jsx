...
<section className=" bg-gray-100 sm:py-4 lg:py-12 px-6 md:px-12 lg:px-24  mt-4">
            <div className='max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between '>
          
            <div className="md:w-1/2 text-center md:text-left">
                <h1 className=" text-5xl  font-bold mb-4 ">Keep track of <span className='text-green-500'>Fitness Goal</span></h1>
                <p className="lg:text-2xl  text-gray-700 mb-6 text-bold r">
            ...
            <div className="relative md:w-1/2 mt-8 md:mt-0 flex justify-center md:justify-end">
                <div className="relative">
                    ...
                    <img
                        src={BannerLogo}
                        alt="House"
                        className="lg:w-96 lg:h-96  object-cover rounded-lg "
                    />
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                        <div className="rounded-full ">
                            <img
                                src={BannerLogo2}
                                alt="Interior"
                                className="lg:w-60  lg:h-60 object-cover rounded-full"
                            />
                        </div>
                    </div>
                </div>
